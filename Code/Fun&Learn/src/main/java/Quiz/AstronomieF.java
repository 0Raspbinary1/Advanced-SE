...
public class AstronomieF {
	...
	public void initQ() {
		this.as = new String[20][6];

		this.as[0][0] = "Die Sonne ist ein...";
		this.as[0][1] = "a) Stern";
		this.as[0][2] = "b) Planet";
		this.as[0][3] = "c) Komet";
		this.as[0][4] = "d) Meteor";
		this.as[0][5] = "a";
		...
		this.as[2][1] = "a) 827 Mio. Jahre";
		this.as[2][2] = "b) 6,9 Mrd. Jahre";
		...
		this.as[3][4] = "d) Uranus, Merkur, Venus, Jupiter, Erde, Mars, Saturn, Neptun";
		this.as[3][5] = "b";
		this.as[4][0] = "Wie weit ist die Erde von der Sonne entfernt?";
		this.as[4][1] = "a) 21 Millionen Kilometer";
		this.as[4][2] = "b) 150 Millionen Kilometer";
		...
		this.as[5][4] = "d) 2 Stunden und 47 Minuten";
		this.as[5][5] = "b";
		this.as[6][0] = "";
		this.as[6][1] = "";
		this.as[6][2] = "";
