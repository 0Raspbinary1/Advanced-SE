...
public class AstronomieF implements Questions{
	...
	public void initQ() {
		...
		this.as[2][5] = "c";
		this.as[3][0] = "Wie lautet die Reihenfolge der Planeten von der Sonne nach au�en?";
		...
		this.as[4][5] = "b";
		this.as[5][0] = "Und wie viel Zeit ben�tigt Licht f�r die Reise von der Sonne zur Erde?";
